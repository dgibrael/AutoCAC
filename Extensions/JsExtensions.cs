...
public static class JsExtensions
{
    ...
    public static async Task SubscribeToBroadcastChannelAsync<T>(
        this IJSRuntime js,
        string channelName,
    ...
    public static async Task PostBroadcastMessageAsync(
        this IJSRuntime js,
        string channelName,
        string message,
    ...
    public static async Task UnsubscribeFromBroadcastChannelAsync(
        this IJSRuntime js,
        string channelName)
    {
        await js.InvokeVoidAsync(
            "appBroadcast.unsubscribe",
            channelName);
    }

    public static async Task OpenTabAsync(this IJSRuntime js, string url)
    {
        await js.InvokeVoidAsync(
            "appBroadcast.openTab",
            url);
    }
}
